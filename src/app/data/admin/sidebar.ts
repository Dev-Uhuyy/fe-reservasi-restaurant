...
export const sidebarItems: SidebarItem[] = [
  ...
  { title: "Rooms Management", url: "/admin/rooms", icon: Warehouse },
  { title: "Table Management", url: "/admin/tables", icon: Armchair },
  { title: "Payment Method Management", url: "/admin/payments", icon: Wallet },
];